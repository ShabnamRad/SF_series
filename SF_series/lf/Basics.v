...
Example test_bin_incr2: (incr (B (B Z))) = A (A (B Z)).
Proof. reflexivity. Qed.
Example test_bin_incr3: (incr (A (A (B Z)))) = B (A (B Z)).
Proof. reflexivity. Qed.
Example test_convert_order: bin_to_nat (incr (A (B Z))) = S (bin_to_nat (A (B Z))).
Proof. reflexivity. Qed.
Example test_mix_incr_convert: bin_to_nat (incr (incr (incr Z))) = 3.
Proof. reflexivity. Qed.
